...
int main(int argc, char *argv[]) {
    ...
    const char *cart_rom_file = "/home/dvlop/projects/pasm/examples/roms/c64/basic.901226-01.bin";
    ...
    if (keyboard_map_file && keyboard_map_file[0]) {
        if (mos6510_load_keyboard_map(cpu, keyboard_map_file) != 0) {
    ...
    if (cart_rom_file && cart_rom_file[0]) {
        if (mos6510_load_cartridge_rom(cpu, cart_rom_file) != 0) {
