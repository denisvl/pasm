...
/* ===== IC Types ===== */
typedef struct ComponentState_vdp0 {
...
typedef struct ComponentState_video_msx {
    ...
    uint32_t width;
    uint32_t height;
} ComponentState_video_msx;

typedef struct ComponentState_speaker_msx {
    uint8_t level;
    uint64_t last_cycle;
...
#define CPU_SYSTEM_NAME "Z80MSX1InteractiveSystem"
