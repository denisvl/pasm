...
int main(int argc, char *argv[]) {
    ...
    const char *cart_rom_file = "/home/dvlop/projects/pasm/examples/roms/Penguin Adventure - Yumetairiku Adventure (1986) Konami [Konami Antiques MSX Collection 3 - RC-743] [2539].rom";
