...
/* ===== IC Types ===== */
typedef struct ComponentState_sms_vdp0 {
    uint32_t frame_counter;
    uint64_t tstate_accum;
    uint64_t line_tstate_accum;
    uint16_t scanline;
    uint16_t vdp_addr;
    ...
    uint8_t h_counter_latch;
    uint8_t * vram;
    uint8_t * cram;
    uint8_t debug_enabled;
} ComponentState_sms_vdp0;

typedef struct ComponentState_sms_joy0 {
    uint8_t joy1;
    uint8_t joy2;
} ComponentState_sms_joy0;
...
typedef struct ComponentState_sms_cart0 {
    uint8_t * rom_data;
    uint32_t rom_size;
    uint8_t bios_visible;
    uint16_t bios_window_size;
    uint8_t control;
    uint8_t bank0;
    uint8_t bank1;
    uint8_t bank2;
...
#define CPU_SYSTEM_NAME "Z80SMSInteractiveSystem"
