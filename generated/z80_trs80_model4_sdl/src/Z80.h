...
/* ===== IC Types ===== */
typedef struct ComponentState_trs80_m4io {
    ...
    uint16_t video_cols;
    uint8_t * rom_shadow;
    uint8_t * low_ram_shadow;
    uint8_t low_shadow_valid;
    uint8_t low_ram_active;
    uint8_t fdc_status;
    uint8_t fdc_track;
    uint8_t fdc_sector;
    uint8_t fdc_data;
    uint8_t fdc_drive_select;
    uint8_t fdc_cmd_pending;
    uint64_t fdc_deadline;
    uint8_t fdc_last_cmd;
    uint8_t fdc_busy;
    uint8_t fdc_drq;
    uint8_t fdc_irq_pending;
    uint16_t fdc_data_index;
    uint16_t fdc_data_count;
    uint8_t * fdc_sector_buffer;
} ComponentState_trs80_m4io;

typedef struct ComponentState_keyboard_trs80 {
    uint8_t last_row;
} ComponentState_keyboard_trs80;

typedef struct ComponentState_video_trs80 {
    uint32_t frame_count;
    uint32_t width;
    uint32_t height;
} ComponentState_video_trs80;

typedef struct ComponentState_speaker_trs80 {
    uint8_t level;
    uint64_t last_cycle;
} ComponentState_speaker_trs80;

typedef struct ComponentState_host_trs80_sdl2 {
    uint8_t sdl_inited;
    void * window;
    void * renderer;
    void * texture;
    ...
    uint8_t row6;
    uint8_t row7;
} ComponentState_host_trs80_sdl2;
...
struct CPUState {
    ...
    ComponentState_trs80_m4io comp_trs80_m4io;
    ComponentState_keyboard_trs80 comp_keyboard_trs80;
    ComponentState_video_trs80 comp_video_trs80;
    ComponentState_speaker_trs80 comp_speaker_trs80;
    ComponentState_host_trs80_sdl2 comp_host_trs80_sdl2;
};
...
#define CPU_SYSTEM_NAME "Z80TRS80Model4InteractiveSystem"
...
/* CPU_SYSTEM_INTEGRATIONS_JSON: {\"profile\": \"trs80_model4_interactive\"} */
