...
if not defined CARTRIDGE_ROM_GEN set "CARTRIDGE_ROM_GEN=../../roms/csx64/basic.901226-01.bin"
...
if not defined CARTRIDGE_DIR set "CARTRIDGE_DIR=%REPO_ROOT%\examples\roms\csx64"
...
if /I "%PROFILE%"=="default" (
  set "SYSTEM=examples/systems/csx64/csx64_cartridge_default.yaml"
  set "DEFAULT_OUTPUT=generated/csx64"
) else if /I "%PROFILE%"=="interactive" (
  set "SYSTEM=examples/systems/csx64/csx64_cartridge_interactive.yaml"
  set "DEFAULT_OUTPUT=generated/csx64_interactive"
) else (
