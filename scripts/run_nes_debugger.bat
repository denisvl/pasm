...
rem if not defined CARTRIDGE_ROM_GEN set "CARTRIDGE_ROM_GEN=../../roms/nes/Super Mario Bros. + Duck Hunt (USA).nes"
if not defined CARTRIDGE_ROM_GEN set "CARTRIDGE_ROM_GEN=../../roms/nes/1942 (Japan, USA).nes"
