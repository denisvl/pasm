...
set "IC_MAIN_RAM=examples/ics/bbcmicro/bbc_micro_model_a_main_ram.yaml"
...
set "DEVICE_MONITOR=examples/devices/common/tv_crt_mono.yaml"
set "HOST_INTERACTIVE=examples/hosts/bbcmicro/bbc_micro_model_a_host_hal_interactive.yaml"
set "HOST_STUB=examples/hosts/bbcmicro/bbc_micro_model_a_host_stub.yaml"

if /I "%PROFILE%"=="default" (
  set "SYSTEM=examples/systems/bbcmicro/bbc_micro_model_a_default.yaml"
  set "DEFAULT_OUTPUT=generated/bbc_micro_model_a_default"
  if not defined HOST_FILE set "HOST_FILE=%HOST_STUB%"
) else if /I "%PROFILE%"=="interactive" (
  set "SYSTEM=examples/systems/bbcmicro/bbc_micro_model_a_interactive.yaml"
  set "DEFAULT_OUTPUT=generated/bbc_micro_model_a_interactive"
