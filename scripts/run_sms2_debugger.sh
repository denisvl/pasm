...
# One-shot helper: generate + build + run PASM Rust debugger for Sega Master System II.
#
# Usage:
#   scripts/run_sms2_debugger.sh [interactive|default]
#
# Optional env overrides:
#   START_PC=0x0000
#   MEMORY_SIZE=65536
#   OUTPUT_DIR=generated/z80_sms2_sdl
...
IC_ASIC="examples/ics/sms2/sms2_asic.yaml"
IC_RF="examples/ics/sms2/sms2_rf_modulator.yaml"
...
case "${PROFILE}" in
  default)
    SYSTEM="examples/systems/sms2/sms2_default.yaml"
    HOST="examples/hosts/sms/sms_host_stub.yaml"
    DEFAULT_OUTPUT="generated/z80_sms2"
    PASM_SMS_DIRECT_PCM="${PASM_SMS_DIRECT_PCM:-0}"
    ;;
  interactive)
    SYSTEM="examples/systems/sms2/sms2_interactive.yaml"
    HOST="examples/hosts/sms/sms_host_hal_interactive.yaml"
    DEFAULT_OUTPUT="generated/z80_sms2_sdl"
