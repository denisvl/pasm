...
set "IC_VDG=examples/ics/coco2/coco2_vdg_6847t1.yaml"
...
set "SYSTEM_DIR=examples/systems/coco2"

if /I "%PROFILE%"=="default" (
  set "SYSTEM=examples/systems/coco2/coco2_default.yaml"
  set "HOST=examples/hosts/coco1/coco_host_stub.yaml"
  set "DEFAULT_OUTPUT=generated/mc6809_coco2"
) else if /I "%PROFILE%"=="interactive" (
  set "SYSTEM=examples/systems/coco2/coco2_interactive.yaml"
  set "HOST=examples/hosts/coco1/coco_host_hal_interactive.yaml"
  set "DEFAULT_OUTPUT=generated/mc6809_coco2_sdl"
) else (
...
if not defined CARTRIDGE_DIR set "CARTRIDGE_DIR=%REPO_ROOT%\examples\roms\coco2"
