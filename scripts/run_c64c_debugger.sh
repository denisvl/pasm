...
# One-shot helper: generate + build + run PASM Rust debugger for Commodore 64C.
#
# Usage:
#   scripts/run_c64c_debugger.sh [interactive|default]
#
# Optional env overrides:
#   START_PC=0xFCE2
#   MEMORY_SIZE=65536
#   OUTPUT_DIR=generated/c64c_interactive
#   EXTRA_CARGO_ARGS="--release"
#   RUN_SPEED=realtime|max
#   CARTRIDGE_MAP=examples/cartridges/c64/c64_cart_auto.yaml
#   CARTRIDGE_ROM_GEN=../../roms/c64c/basic.901226-01.bin
#   CARTRIDGE_ROM_RUNTIME=/abs/path/to/cart.bin
#   CARTRIDGE_DIR=/abs/path/to/c64c/roms
#   BOOT_CARTRIDGE=0|1
...
CARTRIDGE_ROM_GEN="${CARTRIDGE_ROM_GEN:-../../roms/c64c/basic.901226-01.bin}"
...
IC_VIC="examples/ics/c64/c64_vic_ii_8565.yaml"
...
case "${PROFILE}" in
  default)
    SYSTEM="examples/systems/c64c/c64c_cartridge_default.yaml"
    DEFAULT_OUTPUT="generated/c64c"
    ;;
  interactive)
    SYSTEM="examples/systems/c64c/c64c_cartridge_interactive.yaml"
    DEFAULT_OUTPUT="generated/c64c_interactive"
    ;;
  *)
