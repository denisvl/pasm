...
# One-shot helper: generate + build + run PASM Rust debugger for Tandy Deluxe Color Computer (TDP-100).
#
# Usage:
#   scripts/run_tdp100_debugger.sh [interactive|default]
#
# Optional env overrides:
#   START_PC=0xA027
#   MEMORY_SIZE=65536
#   OUTPUT_DIR=generated/mc6809_tdp100_sdl
...
#   BOOT_CARTRIDGE=0|1                          (default 0: boot base TDP-100, then pick cart)
...
case "${PROFILE}" in
  default)
    SYSTEM="examples/systems/tdp100/tdp100_default.yaml"
    HOST="examples/hosts/coco1/coco_host_stub.yaml"
    DEFAULT_OUTPUT="generated/mc6809_tdp100"
    ;;
  interactive)
    SYSTEM="examples/systems/tdp100/tdp100_interactive.yaml"
    HOST="examples/hosts/coco1/coco_host_hal_interactive.yaml"
    DEFAULT_OUTPUT="generated/mc6809_tdp100_sdl"
    ;;
  *)
