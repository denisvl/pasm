...
# One-shot helper: generate + build + run PASM Rust debugger for Sega Mark III.
#
# Usage:
#   scripts/run_sm3_debugger.sh [interactive|default]
#
# Optional env overrides:
#   START_PC=0x0000
#   MEMORY_SIZE=65536
#   OUTPUT_DIR=generated/z80_sm3_sdl
...
case "${PROFILE}" in
  default)
    SYSTEM="examples/systems/sm3/sm3_default.yaml"
    HOST="examples/hosts/sms/sms_host_stub.yaml"
    DEFAULT_OUTPUT="generated/z80_sm3"
    PASM_SMS_DIRECT_PCM="${PASM_SMS_DIRECT_PCM:-0}"
    ;;
  interactive)
    SYSTEM="examples/systems/sm3/sm3_interactive.yaml"
    HOST="examples/hosts/sms/sms_host_hal_interactive.yaml"
    DEFAULT_OUTPUT="generated/z80_sm3_sdl"
