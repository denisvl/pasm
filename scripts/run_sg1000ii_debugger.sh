...
# One-shot helper: generate + build + run PASM Rust debugger for Sega SG-1000 II.
#
# Usage:
#   scripts/run_sg1000ii_debugger.sh [interactive|default]
#
# Optional env overrides:
#   START_PC=0x0000
#   MEMORY_SIZE=65536
#   OUTPUT_DIR=generated/z80_sg1000ii_sdl
...
case "${PROFILE}" in
  default)
    SYSTEM="examples/systems/sg1000ii/sg1000ii_default.yaml"
    HOST="examples/hosts/sg1000/sg1000_host_stub.yaml"
    DEFAULT_OUTPUT="generated/z80_sg1000ii"
    ;;
  interactive)
    SYSTEM="examples/systems/sg1000ii/sg1000ii_interactive.yaml"
    HOST="examples/hosts/sg1000/sg1000_host_hal_interactive.yaml"
    DEFAULT_OUTPUT="generated/z80_sg1000ii_sdl"
    ;;
  *)
