...
rem One-shot helper: generate + build + run PASM Rust debugger for Famicom.
rem
rem Usage:
rem   scripts\run_famicom_debugger.bat [interactive]
rem
rem Optional env overrides:
rem   START_PC=0xC000
rem   MEMORY_SIZE=65536
rem   OUTPUT_DIR=generated/mos6502_famicom_interactive
rem   EXTRA_CARGO_ARGS=--release
rem   CMAKE_BUILD_TYPE=Release
rem   RUN_SPEED=realtime|max
rem   CARTRIDGE_ROM_GEN=../../roms/famicom/1942 (Japan, USA).nes
...
rem Famicom: Player 2 controller is hardwired (always connected).
if not defined PASM_NES_JOY2_CONNECTED set "PASM_NES_JOY2_CONNECTED=1"
if not defined CARTRIDGE_MAP set "CARTRIDGE_MAP=examples/cartridges/famicom/famicom_mapper_auto.yaml"
if not defined CARTRIDGE_ROM_GEN set "CARTRIDGE_ROM_GEN=../../roms/famicom/1942 (Japan, USA).nes"
if not defined KEYBOARD_MAP set "KEYBOARD_MAP=examples/hosts/famicom/host_console_famicom.yaml"
if not defined CONTROLLER_MAP set "CONTROLLER_MAP=examples/hosts/famicom/host_controller_famicom.yaml"
if not defined CARTRIDGE_DIR set "CARTRIDGE_DIR=examples/roms/famicom"
...
set "SYSTEM=examples/systems/famicom/famicom_interactive.yaml"
set "SYSTEM_DIR=examples/systems/famicom"
set "HOST=examples/hosts/famicom/famicom_host_hal_interactive.yaml"
set "IC_BUS=examples/ics/famicom/famicom_cpu_bus.yaml"
set "IC_CTRL=examples/ics/famicom/famicom_controller_ports.yaml"
set "IC_APU=examples/ics/famicom/famicom_apu.yaml"
set "IC_PPU_REGS=examples/ics/famicom/famicom_ppu_regs.yaml"
set "IC_CPU_RAM=examples/ics/nes/nes_cpu_ram.yaml"
set "IC_IO_PORTS=examples/ics/famicom/famicom_io_ports.yaml"
set "IC_CART_BRIDGE=examples/ics/nes/nes_cart_bridge.yaml"
set "DEVICE_CTRL=examples/devices/famicom/famicom_controller.yaml"
...
if not defined OUTPUT_DIR set "OUTPUT_DIR=generated/mos6502_famicom_interactive"
