...
# Self-contained helper: generate + build + run PASM Rust debugger for Famicom.
# Canonical Famicom interactive runner (not a wrapper).
...
OUTPUT_DIR="${OUTPUT_DIR:-generated/mos6502_famicom_interactive}"
