...
# One-shot helper: generate + build + run PASM Rust debugger for Commodore 64GS.
#
# Usage:
#   scripts/run_c64gs_interactive.sh [interactive|default]
#
# Optional env overrides:
#   START_PC=0x0000
#   MEMORY_SIZE=65536
#   OUTPUT_DIR=generated/c64gs_interactive
...
USE_CARTRIDGE_SYSTEM="${USE_CARTRIDGE_SYSTEM:-1}"
...
case "${PROFILE}" in
  default)
    ...
    DEFAULT_OUTPUT="generated/c64gs"
    ;;
  interactive)
    SYSTEM="examples/systems/c64gs/c64gs_interactive.yaml"
    DEFAULT_OUTPUT="generated/c64gs_interactive"
    ;;
  *)
