...
set "SYSTEM_DIR=examples/systems/tdp100"

if /I "%PROFILE%"=="default" (
  set "SYSTEM=examples/systems/tdp100/tdp100_default.yaml"
  set "HOST=examples/hosts/coco1/coco_host_stub.yaml"
  set "DEFAULT_OUTPUT=generated/mc6809_tdp100"
) else if /I "%PROFILE%"=="interactive" (
  set "SYSTEM=examples/systems/tdp100/tdp100_interactive.yaml"
  set "HOST=examples/hosts/coco1/coco_host_hal_interactive.yaml"
  set "DEFAULT_OUTPUT=generated/mc6809_tdp100_sdl"
) else (
