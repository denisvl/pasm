...
rem One-shot helper: generate + build + run PASM Rust debugger for ZX Spectrum 48K.
rem
rem Usage:
rem   scripts\run_zx48_debugger.bat [interactive^|default]
rem
rem Optional env overrides:
rem   START_PC=0x0000
rem   MEMORY_SIZE=65536
rem   OUTPUT_DIR=generated/z80_48k_sdl
