...
# One-shot helper: generate + build + run PASM Rust debugger for Dragon 32.
#
# Usage:
#   scripts/run_dragon32_debugger.sh [interactive|default]
#
# Optional env overrides:
#   START_PC=0xB3B4
#   MEMORY_SIZE=65536
#   OUTPUT_DIR=generated/mc6809_dragon32_sdl
...
#   CARTRIDGE_ROM_GEN=../../roms/dragon32/ddos10.rom
#   CARTRIDGE_ROM_RUN=/abs/path/to/cart.rom  (optional override)
#   CARTRIDGE_DIR=/abs/path/to/dragon32/roms (enable runtime cartridge picker list)
#   BOOT_CARTRIDGE=0|1                        (default 0: boot base Dragon 32, then pick cart)
...
SYSTEM_DIR="examples/systems/dragon32"

if [[ "$PROFILE" == "default" ]]; then
  SYSTEM="examples/systems/dragon32/dragon32_default.yaml"
  HOST="examples/hosts/coco1/coco_host_stub.yaml"
  DEFAULT_OUTPUT="generated/mc6809_dragon32"
else
  SYSTEM="examples/systems/dragon32/dragon32_interactive.yaml"
  HOST="examples/hosts/coco1/coco_host_hal_interactive.yaml"
  DEFAULT_OUTPUT="generated/mc6809_dragon32_sdl"
fi
...
CARTRIDGE_DIR="${CARTRIDGE_DIR:-$REPO_ROOT/examples/roms/dragon32}"
...
echo "[1/3] Generating Dragon 32 emulator -> $OUTPUT_DIR"
...
echo "[2/3] Building Dragon 32 emulator with CMake -> $BUILD_DIR"
