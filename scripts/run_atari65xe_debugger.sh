...
# One-shot helper: generate + build + run PASM Rust debugger for Atari 65XE.
#
# Usage:
#   scripts/run_atari65xe_debugger.sh [interactive|default]
#
# Optional env overrides:
#   START_PC=0xE477            (optional; leave unset to use reset vector)
#   MEMORY_SIZE=65536
#   OUTPUT_DIR=generated/atari65xe_interactive
...
#   BASIC_ROM=../../roms/atari65xe/AtariBasic.rom
...
BASIC_ROM="${BASIC_ROM:-../../roms/atari65xe/AtariBasic.rom}"
...
case "${PROFILE}" in
  default)
    SYSTEM="examples/systems/atari65xe/atari65xe_default.yaml"
    HOST="examples/hosts/atari800xl/atari800xl_host_stub.yaml"
    DEFAULT_OUTPUT="generated/atari65xe_default"
    ;;
  interactive)
    SYSTEM="examples/systems/atari65xe/atari65xe_interactive.yaml"
    HOST="examples/hosts/atari800xl/atari800xl_host_hal_interactive.yaml"
    DEFAULT_OUTPUT="generated/atari65xe_interactive"
    ;;
  *)
...
TMP_SYSTEM="${SYSTEM_DIR_ABS}/.tmp_atari65xe_system_${$}_$RANDOM.yaml"
touch "${TMP_SYSTEM}"
...
for rom in rom_images:
    ...
    if name == "atari65xe_basic":
        rom["file"] = basic_rom
    elif name == "atari65xe_selftest":
        rom["file"] = selftest_rom
    elif name == "atari65xe_os_low":
        rom["file"] = os_low
    elif name == "atari65xe_os_high":
        rom["file"] = os_high
