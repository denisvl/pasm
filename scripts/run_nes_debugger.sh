...
case "${PROFILE}" in
  default)
    SYSTEM="examples/systems/nes/mos6502_nes_default.yaml"
    HOST="examples/hosts/nes/nes_host_stub.yaml"
    DEFAULT_OUTPUT="generated/mos6502_nes_default"
    ;;
  interactive)
    SYSTEM="examples/systems/nes/mos6502_nes_interactive.yaml"
    HOST="examples/hosts/nes/nes_host_sdl2_interactive.yaml"
