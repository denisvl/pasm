...
set "SYSTEM_DIR=examples/systems/dragon32"

if /I "%PROFILE%"=="default" (
  set "SYSTEM=examples/systems/dragon32/dragon32_default.yaml"
  set "HOST=examples/hosts/coco1/coco_host_stub.yaml"
  set "DEFAULT_OUTPUT=generated/mc6809_dragon32"
) else if /I "%PROFILE%"=="interactive" (
  set "SYSTEM=examples/systems/dragon32/dragon32_interactive.yaml"
  set "HOST=examples/hosts/coco1/coco_host_hal_interactive.yaml"
  set "DEFAULT_OUTPUT=generated/mc6809_dragon32_sdl"
) else (
...
if not defined CARTRIDGE_DIR set "CARTRIDGE_DIR=%REPO_ROOT%\examples\roms\dragon32"
...
if "%USE_CARTRIDGE%"=="1" (
  ...
  if "%CARTRIDGE_ROM_GEN%"=="" if "%CARTRIDGE_ROM_RUN%"=="" set "CARTRIDGE_ROM_GEN=../../roms/dragon32/ddos10.rom"
)
...
if "%USE_CARTRIDGE%"=="1" (
  ...
  if "!CARTRIDGE_ROM_RUNTIME!"=="" set "CARTRIDGE_ROM_RUNTIME=%REPO_ROOT%\examples\roms\dragon32\ddos10.rom"
  if not exist "!CARTRIDGE_ROM_RUNTIME!" for %%I in ("%REPO_ROOT%\%CARTRIDGE_ROM_GEN%") do set "CARTRIDGE_ROM_RUNTIME=%%~fI"
  if "!CARTRIDGE_ROM_RUNTIME!"=="" for %%I in ("%REPO_ROOT%\examples\roms\dragon32\ddos10.rom") do set "CARTRIDGE_ROM_RUNTIME=%%~fI"
