...
from src.parser.yaml_loader import ISALoader
...
class EmulatorGenerator:
    ...
    def __init__(self, isa_path: str):
        """Initialize generator with ISA file path."""
        self.loader = ISALoader()
        self.isa_data = self.loader.load(isa_path)
        self.isa_path = Path(isa_path)
    ...
    def generate(self, output_dir: str, dispatch_mode: str = "switch") -> None:
        ...
        print(f"Generating {self.cpu_name} emulator to {output_dir}")
...
def generate(isa_path: str, output_dir: str, dispatch_mode: str = "switch") -> None:
    """Convenience function to generate an emulator."""
    generator = EmulatorGenerator(isa_path)
